...
namespace UNO
{
    namespace Common
    {
        ...
        Config::Config(int argc, const char **argv)
        {
            ...
            mOptions->add_options()(CMD_OPT_BOTH_LISTEN, "the port number that server will listen on", cxxopts::value<std::string>())(CMD_OPT_BOTH_CONNECT, "the endpoint that client (player) will connect to", cxxopts::value<std::string>())(CMD_OPT_BOTH_USERNAME, "the username of the player", cxxopts::value<std::string>())(CMD_OPT_BOTH_PLAYERS, "the number of players", cxxopts::value<int>())(CMD_OPT_BOTH_CFGFILE, "the path of config file", cxxopts::value<std::string>())(CMD_OPT_LONG_LOGFILE, "the path of log file", cxxopts::value<std::string>())(CMD_OPT_BOTH_VERSION, "show version of application", cxxopts::value<bool>())(CMD_OPT_BOTH_HELP, "show help info", cxxopts::value<bool>())(CMD_OPT_BOTH_TEST, "start test version", cxxopts::value<bool>());
        ...
        void Config::ParseCmdlineOpts()
        {
            ...
            if (mCmdlineOpts->count(CMD_OPT_LONG_CONNECT) && !mCmdlineOpts->count(CMD_OPT_LONG_USERNAME) && (!mClientNode || !(*mClientNode)[FILE_OPT_USERNAME].IsDefined()))
            {
