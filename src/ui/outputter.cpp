...
namespace UNO
{
    namespace UI
    {
                                      ...
                                      bool hasChanceToPlayAfterDraw) const
        {
            if (isSpecifyingNextColor)
            {
                std::cout << "Specify the next color ("
                          ...
                          << ToColorEscape(CardColor::BLACK) << "B" << ColorEscape::RESET << "/"
                          << ToColorEscape(CardColor::FLOWER) << "F" << ColorEscape::RESET << "/"
                          << ToColorEscape(CardColor::SQUARE) << "S" << ColorEscape::RESET << ")." << std::endl;
            }
        ...
        std::string Outputter::ToColorEscape(CardColor color) const
        {
            ...
            {
            case CardColor::RED:
                return ColorEscape::RED;
            case CardColor::FLOWER:
                return ColorEscape::YELLOW;
            case CardColor::SQUARE:
                return ColorEscape::GREEN;
            case CardColor::BLACK:
                return ColorEscape::BLUE;
            // case CardColor::BLACK:  return ColorEscape::BLACK;
            default:
                return ColorEscape::RESET;
            }
        }
        ...
        std::vector<RenderInfo> Outputter::GetRenderInfos() const
        {
            ...
            renderInfos.emplace_back(ViewFormatter::GetPosOfUNOText('U'),
                                     Game::Card(Game::CardColor::RED, Game::CardText::ACE));
            renderInfos.emplace_back(ViewFormatter::GetPosOfUNOText('N'),
                                     Game::Card(Game::CardColor::BLACK, Game::CardText::ACE));
            renderInfos.emplace_back(ViewFormatter::GetPosOfUNOText('O'),
                                     Game::Card(Game::CardColor::FLOWER, Game::CardText::ACE));
            renderInfos.emplace_back(ViewFormatter::GetPosOfUNOText('!'),
                                     Game::Card(Game::CardColor::SQUARE, Game::CardText::ACE));
